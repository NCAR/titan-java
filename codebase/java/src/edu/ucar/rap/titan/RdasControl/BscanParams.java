...
class BscanParams extends CollectionParameter
    
{
    
    public DoubleParameter maxRange;
    public DoubleParameter deltaAzimuth;
    ...
    public BscanParams(String name, String label, int depth)
    {
	...
	// expected delta azimuth
	
	deltaAzimuth = new DoubleParameter("deltaAzimuth");
	deltaAzimuth.setLabel("Delta azimuth");
	deltaAzimuth.setDescription("Expected delta azimith - deg");
	deltaAzimuth.setInfo("This is the expected azimith spacing between beams in degrees. When rendering, the beam will be made slightly larger than this to prevent unwanted gaps.");
	deltaAzimuth.setValue(1.0);
