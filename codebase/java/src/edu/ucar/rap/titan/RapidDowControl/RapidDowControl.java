...
class RapidDowControl

{
  
  private String _procName = "RapidDowControl";
  ...
  public RapidDowControl(String[] args)
  {
    ...
    Runtime.getRuntime().addShutdownHook(new RapidDowControlShutdown());
  ...
  private void usage() {
    System.out.println("Usage: RapidDowControl [-opts as below]");
  ...
  private void version() {
    System.out.println("RapidDowControl version: " + _version);
    System.exit(1);
  }
  ...
  public static void main(String args[])
  {
    ...
    RapidDowControl app = new RapidDowControl(args);
  ...
  private class Gui extends JFrame
  {
    ...
    public Gui(RapidDowControl app) {
    ...
    private void _setTitleStr() {
      String frameTitle = "RAPID DOW CONTROL " +
        _version + " - " +
...

    {
      ...
      public void paintComponent (Graphics g) {
        ...
        if (_status != null) {
          ...
          int nGates = _status.pentek1.n_gates;
  ...
  private class RapidDowControlShutdown extends Thread {
    public void run() {
